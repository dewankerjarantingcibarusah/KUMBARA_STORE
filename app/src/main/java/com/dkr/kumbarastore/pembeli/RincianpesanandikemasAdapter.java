...
public class RincianpesanandikemasAdapter extends RecyclerView.Adapter<RincianpesanandikemasAdapter.ViewHolder> {
    private List<Product> productList;
    private Context context;

    public RincianpesanandikemasAdapter(Context context, List<Product> productList) {
