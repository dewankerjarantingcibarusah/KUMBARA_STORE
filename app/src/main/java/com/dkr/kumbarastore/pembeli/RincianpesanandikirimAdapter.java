...
public class RincianpesanandikirimAdapter extends RecyclerView.Adapter<RincianpesanandikirimAdapter.ViewHolder> {
    private List<Product> productList;
    private Context context;

    public RincianpesanandikirimAdapter(Context context, List<Product> productList) {
