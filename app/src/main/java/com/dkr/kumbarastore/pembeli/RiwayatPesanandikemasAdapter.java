...
public class RiwayatPesanandikemasAdapter extends RecyclerView.Adapter<RiwayatPesanandikemasAdapter.OrderViewHolder> {

    private Context context;
    private List<Order> orderList;

    public RiwayatPesanandikemasAdapter(Context context, List<Order> orderList) {
