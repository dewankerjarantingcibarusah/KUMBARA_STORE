...
public class RiwayatPesanandikirimAdapter extends RecyclerView.Adapter<RiwayatPesanandikirimAdapter.OrderViewHolder> {

    private Context context;
    private List<Order> orderList;

    public RiwayatPesanandikirimAdapter(Context context, List<Order> orderList) {
    ...
    public void onBindViewHolder(@NonNull OrderViewHolder holder, int position) {
        ...
        holder.txtDikemas.setText("Dikirim");
        ...
        for (Product product : order.getProducts()) {
            ...
            holder.productsLayout1.setOnClickListener(v -> {
                Intent intent = new Intent(context, RincianpesanandikirimActivity.class);
