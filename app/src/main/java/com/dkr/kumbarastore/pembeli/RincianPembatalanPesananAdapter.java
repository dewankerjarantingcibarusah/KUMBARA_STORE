...
public class RincianPembatalanPesananAdapter extends RecyclerView.Adapter<RincianPembatalanPesananAdapter.ViewHolder> {
    private List<Product> pembatalanlist;
    private Context context;

    public RincianPembatalanPesananAdapter(Context context, List<Product> productList) {
        this.context = context;
        this.pembatalanlist = productList;
    }
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        Product product = pembatalanlist.get(position);
